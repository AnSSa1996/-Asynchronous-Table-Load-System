...
namespace Sinbad {
    ...
    public static class CsvUtil {
        ...
        public static NativeArray<byte> LoadCsvFileData(string filePath)
        {
            var fileData = File.ReadAllBytes(filePath);
            var nativeFileData = new NativeArray<byte>(fileData.Length, Allocator.TempJob);
            nativeFileData.CopyFrom(fileData);
